...
function emojifyWord(word) {
  //check if word starts or ends with colon, if no return word
  if (!word.startsWith(":") && !word.endsWith(":")) {
    return word;
  }
  //if yes, remove colons
...
function emojifyPhrase(phrase) {
  let phraseArray = phrase
    ...
    .join(" ");
  // should map over each word in the phrase
  return phraseArray;
}
...
// alternative solution for first function
function emojifyWord(word) {
