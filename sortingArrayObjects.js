...
function sortByDuration(data, flightLength) {
  let sortedArray = [];
  //check the lenght of the flight
  //if flight is 60 || <60
  if (flightLength <= 60) {
  ...
  //create a numbered list, title and duration of each podcast
...
function sortByDuration(data, flightLength) {
  ...
  // loop through my sorted array. deconstruct item to indicate the properties to be used
